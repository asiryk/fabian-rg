...
use crate::searcher::parallel_work_stealing_searcher::work_stealing::WorkStealingQueue;
use crate::searcher::parallel_work_stealing_searcher::worker::{BufferedWorker, split_into_ranges};

/// Searcher that performs it's search using multithreading
#[derive(Debug)]
pub struct ParallelWorkStealingSearcher {
    threads: usize,
    searcher: Searcher,
}

impl ParallelWorkStealingSearcher {
    /// Create new parallel searcher
    pub fn new(threads: usize, searcher: Searcher) -> Self {
        ParallelWorkStealingSearcher { threads, searcher }
    }
...
mod worker {
    ...
    mod tests {
        ...
        use crate::searcher::parallel_work_stealing_searcher::worker::split_into_ranges;
